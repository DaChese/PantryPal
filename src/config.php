 ...
 * Set SPOONACULAR_API_KEY, MYSQLHOST, MYSQL_DATABASE, MYSQLUSER,
 * MYSQL_ROOT_PASSWORD, and MYSQLPORT in your Railway service variables.
 */
...
// API SETTINGS
// =============================================
define('SPOONACULAR_API_KEY', getenv('SPOONACULAR_API_KEY') ?: '');
